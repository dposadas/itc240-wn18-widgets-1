...
<html lang="en">
  ...
  <head>
    ...
    <!-- Custom styles for this template, switched from casual.min.css -->
    <link href="<?=$config->theme_virtual?>css/business-casual.css" rel="stylesheet"> 
    <script defer src="https://use.fontawesome.com/releases/v5.0.6/js/all.js"></script>
      <!-- is =config->loadhead part from bus cas theme needed here?  -->
  </head>
...
<!--
    ...
    <section class="page-section cta">
      <div class="container">
          <h1 style="text-align: center;" class="pageID"><i class="fas <?=$config->logo?>"></i> <?=$config->PageID?></h1>
        <div class="row">
